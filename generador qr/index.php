...
<html lang="en-US">
	<head>
	<title>Generador de Códigos QR en PHP</title>
	...
	<body onload="startTime()">
		<nav class="navbar-inverse" role="navigation">
			...
			<div class="pagevisit">
				<div class="visitcount">
					...
					echo "Esta pagina tiene ".$counter." visitas";
					$handle =  fopen($f, "w" ) ;
		...
		<div class="myoutput">
			<h3><strong>Generador de Códigos QR en PHP</strong></h3>
			...
			?>
			<div class="qr-field">
				<h2 style="text-align:center">Codigo QR: </h2>
				<center>
					<div class="qrframe" style="border:2px solid black; width:210px; height:210px;">
							<?php echo '<img src="temp/'. @$filename.'.png" style="width:200px; height:200px;"><br>'; ?>
					</div>
					<a class="btn btn-primary submitBtn" style="width:210px; margin:5px 0;" href="download.php?file=<?php echo $filename; ?>.png ">Descargue el Codigo QR</a>
				</center>
			</div>
